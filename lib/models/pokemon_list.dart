...
final List<Pokemon> starterPokemonList = [
  ...
  Pokemon(pokemonName: 'Charmander', nickname: 'Torch', pokemonId: 7, pokemonType: 'Fire', trainerId: 7, level: 6, ability1: 'Scratch', ability2: 'Growl', ability3: 'Ember', ability4: 'Smokescreen', attack: 53, health: 40),
  ...
  Pokemon(pokemonName: 'Charmander', nickname: 'Sunny', pokemonId: 11, pokemonType: 'Fire', trainerId: 11, level: 14, ability1: 'Flamethrower', ability2: 'Fire Fang', ability3: 'Slash', ability4: 'Growl', attack: 69, health: 51),
  ...
  Pokemon(pokemonName: 'Charmander', nickname: 'Flicker', pokemonId: 13, pokemonType: 'Fire', trainerId: 13, level: 4, ability1: 'Scratch', ability2: 'Growl', ability3: 'Ember', ability4: 'Smokescreen', attack: 51, health: 38),
  ...
  Pokemon(pokemonName: 'Bulbasaur', nickname: 'Sprout', pokemonId: 17, pokemonType: 'Grass', trainerId: 17, level: 12, ability1: 'Seed Bomb', ability2: 'Take Down', ability3: 'Leech Seed', ability4: 'Vine Whip', attack: 60, health: 54),
  ...
  Pokemon(pokemonName: 'Bulbasaur', nickname: 'Petal', pokemonId: 21, pokemonType: 'Grass', trainerId: 21, level: 6, ability1: 'Growl', ability2: 'Tackle', ability3: 'Leech Seed', ability4: 'Vine Whip', attack: 50, health: 46),
  ...
  Pokemon(pokemonName: 'Bulbasaur', nickname: 'Ivy', pokemonId: 24, pokemonType: 'Grass', trainerId: 24, level: 11, ability1: 'Vine Whip', ability2: 'Razor Leaf', ability3: 'Growl', ability4: 'Tackle', attack: 57, health: 53),
  ...
  Pokemon(pokemonName: 'Squirtle', nickname: 'Bubble', pokemonId: 31, pokemonType: 'Water', trainerId: 31, level: 15, ability1: 'Bubble', ability2: 'Tackle', ability3: 'Tail Whip', ability4: 'Water Gun', attack: 64, health: 57),
  ...
  Pokemon(pokemonName: 'Squirtle', nickname: 'Splash', pokemonId: 33, pokemonType: 'Water', trainerId: 33, level: 10, ability1: 'Water Pulse', ability2: 'Bite', ability3: 'Tackle', ability4: 'Water Gun', attack: 55, health: 51),
  ...
  Pokemon(pokemonName: 'Squirtle', nickname: 'Rain', pokemonId: 39, pokemonType: 'Water', trainerId: 39, level: 16, ability1: 'Hydro Pump', ability2: 'Aqua Tail', ability3: 'Bite', ability4: 'Water Gun', attack: 66, health: 59),
  Pokemon(pokemonName: 'Squirtle', nickname: 'Drizzle', pokemonId: 40, pokemonType: 'Water', trainerId: 40, level: 4, ability1: 'Tackle', ability2: 'Tail Whip', ability3: 'Water Gun', ability4: 'Withdraw', attack: 47, health: 43),
];
